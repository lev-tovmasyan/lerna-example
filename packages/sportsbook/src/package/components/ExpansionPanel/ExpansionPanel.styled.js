    ...
    css`
      ...
      & > ${ExpansionPanelHead__styled} {
        ...
        background-color: ${props =>
          props.theme.mode === 'starsBet' ? '#e8b116' : 'var(--color-active)'};
    ...
    css`
      ...
      & > ${ExpansionPanelHead__styled} {
        ...
        & ${ExpansionPanelTitle__styled} {
          font-weight: 800;
          color: ${props =>
            props.theme.mode === 'starsBet' ? '#ffffff' : 'var(--color-text)'};
        }
      }
    `}
`;
...
export const ExpansionPanelBody__styled = styled.div`
  padding: 0.56rem 0.56rem 0.06rem 0.56rem;
  width: 100%;
  display: flex;
  align-items: center;
  flex-wrap: wrap;
