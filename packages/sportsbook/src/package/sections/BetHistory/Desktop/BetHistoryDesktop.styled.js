...
export const HistoryClose__styled = styled.div`
  position: absolute;
  top: 0;
  right: 0;
  bottom: 0;
...
export const HistoryHead__styled = styled.div`
  display: flex;
  align-items: center;
...
export const HistoryHeadTitle__styled = styled.div``;

export const HistoryHeadClose__styled = styled.button`
  display: flex;
  align-items: center;
  justify-content: center;
  position: absolute;
